...
const App = () => {
  ...
  const {canRef, red, modelRef, modelReady} = useTheme();
  ...
  const interval = setInterval(() => {
    ...
    const tl2 = gsap.timeline({
      scrollTrigger: {
        ...
        scrub: 1,
        markers: true,  // remove when working
      }
    })

    tl2.to(modelRef.current.rotation, { y: 3.9, duration: 1, })
    tl2.to(modelRef.current.position,{z:isTabletOrMobile ? 20 : 30,y:-6,x:isTabletOrMobile ? 1 : 0, duration: 1,}, '<')
